        ...
        if (userFound) {
          models.comments
            ...
            .catch(function (error) {
              return res
                .status(500)
                .json({ error: "cannot create comment" + error });
            });
        } else {
                ...
                models.comments
                  ...
                  .then(function (commentFound) {
                    if (commentFound || userFound.isAdmin != null) {
                      if (
                        commentFound.dataValues.userId == userFound.id ||
                        userFound.isAdmin != null
                      ) {
                        commentFound.update({
                        ...
                        return res
                          ...
                          .json({
                            error:
                              "you don't have the rights to update this comment",
                          });
                      }
                    } else {
                      return res
                  ...
                  .then(function (commentFound) {
                    if (commentFound || userFound.isAdmin != null) {
                      if (
                        ...
                        return res
                          .status(200)
                          .json({ success: "your comment has been deleted" });
                      } else {
                        return res
                          .status(403)
                          .json({
                            error:
                              "you don't have the rights to delete this comment",
                          });
                      }
                    } else {
                      return res
