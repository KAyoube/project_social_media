...
exports.getAllPosts = async (req, res) => {
  ...
  const postAll = await fetch(`http://${process.env.API_HOST}/api/posts/all/`, {
    headers: {
...
exports.getPostById = async (req, res) => {
  ...
  const postById = await fetch(
    `http://${process.env.API_HOST}/api/posts/getCommentsPosts/${req.params.id}`,
    {
      method: "GET",
...
exports.updatePost = async (req, res) => {
  fetch(`http://${process.env.API_HOST}/api/posts/update/${req.params.id}`, {
    // Adding method type
    method: "PUT",
...
exports.deletePost = async (req, res) => {
  const postDelete = await fetch(
    `http://${process.env.API_HOST}/api/posts/delete/${req.params.id}`,
    {
      method: "DELETE",
      headers: {
        Authorization: localStorage.getItem("token"), // Token à récupérer
